...
In the present cubic-lattice picture, $\alpha$ is not merely a background strain label: it is the primary control parameter for amplitude-to-lateral coupling and therefore for the effective mixing of the nominally axis-aligned carrier branches, while the additional neighbor shells mainly tune isotropy and high-$k$ dispersion around that basic mechanism.
...
In that sense, $\alpha$ is the main physical knob that turns transverse amplitude into lateral restoring forces and therefore governs the onset of branch mixing in the axis-aligned triplet sector.
