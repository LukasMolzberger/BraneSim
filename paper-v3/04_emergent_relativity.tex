...
In particular, slowly varying transverse profiles $u=X^4$ modify intrinsic distances already at the level of the induced metric (\Cref{eq:metric-graph,subsec:gravity-channel}), and can therefore be read as a background that focuses or defocuses wave transport in close analogy to a weak gravitational field.
