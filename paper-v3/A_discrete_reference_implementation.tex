\section{Discrete lattice substrate (implementation notes)}
\label{app:discrete}
...
(ii) as an implementation vehicle to test the continuum long-wavelength limit, dispersion, holonomy diagnostics,
and localized-mode stability.
