...
through covariant derivatives (rank \(r=1\) U(1) Berry, or \(r>1\) Wilczek--Zee), and strong spatial variation of the
...
Choose a localization scale \(a\) and amplitude ratio \(\varepsilon:=A/a\).
