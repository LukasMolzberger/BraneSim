...
\subsection{Effective action sketch}
This subsection states the minimal derivation steps required; completing the coarse-graining calculation is part of the remaining work.
\begin{enumerate}
