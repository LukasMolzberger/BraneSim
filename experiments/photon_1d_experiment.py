...
def main():
    ...
    report = ReportData(
        ...
        symbol_map=[
            ...
            ("rho_1_kg_per_m", r"\(\rho_m\)", "Linear mass density in the continuum wave equation."),
            ("T_1_newton", r"\(T\)", "Effective tension in the linearized wave equation."),
            ("k_spring_N_per_m", r"\(k\)", "Discrete spring constant in the lattice model."),
            ("c_wave_sim", r"\(c_{\mathrm{wave}}\)", "Wave speed used for calibration (approx. c in physical units)."),
