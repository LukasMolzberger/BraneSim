...
This paper is the \emph{shared foundation} for the series: it establishes the substrate model and derives the linearized
wave-branch exports that each companion paper imports.
It does not develop any specific bridge in quantitative detail; those treatments appear in the companion papers
(\Cref{sec:series-scope}), including the retrocausal worldtube interpretation forced by Bell's theorem, which is
developed separately in Paper~V.
