...
A free electromagnetic excitation is precisely such an unconfined linear wave: it is a
polarization eigenbundle transported over spacetime (the gauge bridge, Paper~III), a vector
(spin-$1$) mode carrying no self-confinement and no angular eigenproblem of its own.
It therefore inherits no discrete spectrum from the substrate --- the photon is \emph{not} an
intrinsically quantized object. The discreteness one observes in light (a single detector event,
an energy $\hbar\omega$ exchanged in one lump) is borrowed from the confined matter solitons it
interacts with: it is the bound electron's discrete level structure, not the field's, that
quantizes the exchange. This asymmetry --- continuous, unquantized radiation versus discrete,
self-confined matter --- is taken up at the interpretive level in Paper~V.
