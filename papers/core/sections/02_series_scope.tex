...
The emergence program is organized as a series of four papers sharing a common substrate
...
\begin{itemize}
  ...
  \item \textbf{Bell interpretive commitment:} the retrocausal worldtube reading
  (\Cref{sec:bell-interpretation}), imported by all companion papers as the shared ontological stance
...
four papers as currently scoped:
\begin{itemize}
...
Bell's theorem is developed in \Cref{sec:bell-interpretation} as part of this core paper rather than as a
bridge paper, because it constrains the ontological interpretation of the substrate before any
specific emergent phenomenon is considered.
