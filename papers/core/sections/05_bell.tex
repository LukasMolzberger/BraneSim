...
The theory developed in \Cref{sec:continuum-model,sec:waves} is manifestly local and deterministic: a classical brane action whose dynamics is fixed by the embedded configuration, with all emergent objects (effective metric, gauge connections, soliton labels) derived as read-outs of the substrate state.
