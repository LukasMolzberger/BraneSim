...
The gauge and color bridges identify emergent $U(1)$ and $SU(3)$ structure from eigenbundle
transport, but this paper does \emph{not} claim a derivation of the full Standard Model gauge
group, its generation structure, or precise coupling constants.
Nor does it claim a derivation of the QCD-versus-EM scale hierarchy from the prestress parameter
$\alpha$: $\alpha$ sets a coupling ratio in the linear spectrum, but whether a true dynamical
scale hierarchy emerges from the nonlinear sector is unsettled.
