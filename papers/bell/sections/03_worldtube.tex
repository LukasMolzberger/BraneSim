...
localized mode (\Cref{sec:substrate}) may propagate forward or backward along it --- a
...
substrate structure set out in \Cref{sec:substrate}.
...
A converged periodic-boundary-condition eigenstate of the substrate --- a soliton solution closed
in the timelike direction --- is not a static snapshot;
...
\begin{enumerate}
  ...
  of the soliton and the time orientation of the worldtube closure condition.
