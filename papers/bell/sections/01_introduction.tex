...
The present paper separates that commitment into a standalone treatment, develops the constructive
case for the retrocausal reading, and traces its consequences for how the simulation program
should interpret its own results.

\paragraph{Why Bell cannot be left implicit.}
The substrate is deterministic (\Cref{eq:brane-eom}) and local (all forces are
