...
are photons. In the substrate ontology a free photon is not a quantized object at all: it is the
unconfined $U(1)$ carrier, a continuous spin-$1$ polarization wave with no self-confinement and no
discrete spectrum of its own (Paper~I \Cref{subsec:continuous-waves}, Paper~III
\Cref{subsec:spinorial-holonomy}). It carries only a polarization. The quantization one associates
with light --- a single click, one lump of energy $\hbar\omega$, a definite ``which-detector''
outcome --- is therefore \emph{not} a property of the field in flight; it is imposed at the
detector, where the continuous wave couples to a bound electron, a confined spin-$\tfrac12$
soliton whose self-confinement and angular structure supply the discrete level structure that
turns a continuous arrival into a discrete event. The apparent randomness and apparent
quantization of a photon measurement are thus inherited from the matter that measures it, not
intrinsic to the photon. This is exactly the relocation above made concrete: the probabilistic,
quantized description attaches to the emergent, confined matter solitons (Paper~IV), while the
radiation connecting them remains a definite, continuous substrate field. It also clarifies what
the worldtube of an ``entangled photon pair'' is --- a branching wave connecting two matter
vertices --- and locates the Born-rule statistics to be recovered (\Cref{subsec:bell-open}) at the
detector electron rather than in the light.
