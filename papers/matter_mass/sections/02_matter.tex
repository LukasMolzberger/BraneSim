...
orders of a Fraunhofer diffraction pattern, the normal modes of a cavity --- emerge from boundary
conditions on a continuous medium, with no fundamental quantum of the field.
...
problem separate from confinement; it is the same confinement question developed in Paper~IV (the
kinematic color confinement of the $SU(3)$ sector and the topological $\pi_3$ texture).
...
balance below; the $SU(3)$ confinement of the color sector (no free colored asymptotic state; the
$\pi_3(SU(3))$ winding, Paper~IV) is expected to be load-bearing as well, and the two must
ultimately be assessed together.
