...
\begin{equation}
  ...
  \tag{P1:\ref{eq:linear-dispersion}}
\end{equation}
...
The dual-observer mechanism is the substrate realization of the original, dynamical reading of
length contraction.
FitzGerald \citep{FitzGerald1902} and Lorentz \citep{Lorentz1904} proposed that moving rods
physically contract because the forces binding matter are transmitted through the same medium as
light, so rulers and signal cones renormalize together --- exactly the statement that the
distance/transit-time ratio is direction-independent in the present framework.
Walstad \citep{Walstad2015} further shows that relativistic momentum and kinetic energy follow
from a modification of Einstein's energy--inertia argument \citep{Einstein1905inertia} without
assuming the relativity postulates, paralleling the present derivation of effective Lorentz
kinematics from substrate mechanics rather than from postulated invariance.
