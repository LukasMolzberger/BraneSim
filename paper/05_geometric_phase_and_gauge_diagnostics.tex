...
about its carrier $\mathbf{k}_0$; they are not the base space of the gauge connection. The
link-variable construction below is accordingly a \emph{template diagnostic} --- it returns
