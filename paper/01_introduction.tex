...
\Cref{fig:theory-structure} provides a layer-by-layer roadmap of this logical spine.

\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.72\textwidth,height=0.82\textheight,keepaspectratio]{diagrams/theory_structure}
  \caption{Roadmap of the theory structure. Six layers run from the lab ontology (L1: symmetric 4D Euclidean ambient) through brane structure (L2), the emergent bridge (L3), inside-observer effective physics (L4: Lorentzian metric, gravity channel, and $U(3)$ gauge sector), soliton matter content (L5: VSH ansatz, combined particle labels, soliton chirality), and the Bell/entanglement stance (L6: V-branching worldtubes). The figure traces the lattice-to-continuum-to-emergent-kinematics/gauge/localized-mode spine of the framework; no arrow in it constitutes a derivation not carried out in the body of the paper.}
