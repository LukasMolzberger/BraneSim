...
From the quadratic term $W_2$ of the central-force spring's continuum expansion
(\Cref{subsec:constitutive-law}), the characteristic speeds at long wavelengths are
\begin{equation}
  c_T^2 = \frac{\mu(\alpha)}{\rho_m} = \frac{(1-\alpha)\,k_s a^2}{m},
  \qquad
  c_L^2 = \frac{\lambda+2\mu}{\rho_m} = \frac{k_s a^2}{m},
  \label{eq:cl-ct}
\end{equation}
derived from the acoustic tensor \eqref{eq:acoustic-tensor} on the 6-neighbor stencil.
These coincide with the closed-form dispersion of the discrete action \eqref{eq:discrete-4d-action}
(\Cref{eq:cone-speeds}), confirming that the spring and its $W_2$ continuum limit are
self-consistent across all levels of description.
