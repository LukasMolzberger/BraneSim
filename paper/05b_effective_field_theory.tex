...
the present paper.
(These remain open investigations.)
...
Whether this coupling dynamically co-locates the charge with the color core --- so that a charged baryon binds rather than fragmenting --- is a target of the numerical program, not a conclusion of the present paper.
