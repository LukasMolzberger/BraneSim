...
\paragraph{Companion falsifiable check for the $U(1)$/EM sector.}
The long-range behavior of the $U(1)$ trace sector around a bound carrier vortex provides a sharp additional test of
the electromagnetic identification: a power-law far-field tail of the effective magnetic/supercurrent field would
indicate an unscreened, massless long-range mode consistent with electromagnetism, whereas an exponentially screened
tail with a finite penetration depth would indicate that the condensed substrate Meissner-screens its own $U(1)$
--- an Anderson--Higgs / massive-boson outcome --- which would \emph{falsify} the electromagnetic identification of
the trace sector.
This is an open, unresolved tension in the construction that the theory must pass; the far-field screening behavior
