...
\begin{figure}[tbp]
  ...
  No claim is made of a particle, emergent electromagnetism, or a stable soliton (\Cref{sec:scope}, non-claims; \texttt{OPEN\_PROBLEMS.md} D4).}
...
The concrete four-candidate ansatz menu used in the simulation search is recorded in
