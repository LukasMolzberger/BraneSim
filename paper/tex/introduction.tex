...
The structure of the paper follows a substrate--first perspective and is organized
as a layered model.
Section~\ref{conceptual-model} defines the microscopic brane substrate (degrees
of freedom, action, equations of motion) and introduces the analytical
\emph{spectral-to-Berry-to-gauge} pipeline used to interpret emergent gauge structure.
Section~\ref{emergent-relativity-and-lorentz-invariance} discusses how Lorentz-like
kinematics can arise effectively from the linear wave regime of the substrate.
Section~\ref{sec:internal-structure-of-the-electron} specifies the target internal
electron structure (toroidal/solitonic) that motivates the later diagnostics.
Section~\ref{experimental-setting} describes the discrete simulation framework and
the practical implementation of the pipeline (band isolation, numerical Berry
connection/curvature, reconstruction of effective gauge fields), including a falsifiable
test plan.
Finally, Sections~\ref{discussion} and~\ref{conclusion} summarize limitations, open
problems, and implications.

In this version, the primary focus is the initialization targets and the Berry/holonomy
diagnostic pipeline; curvature toy-calculations are treated as optional future work.
...
mathematical structure is used diagnostically: after isolating a narrowband substrate mode, we
compute the associated connection/holonomy to test whether an effective gauge-like description is
