...
higher-dimensional space. A key feature of this model is that
...
quantum vacuum~\cite{Sakharov1967VacuumGravity}, while the analogue-gravity
programme shows how effective Lorentzian metrics and general-relativistic phenomena
can emerge in condensed-matter systems such as superfluids and Bose--Einstein
condensates~\cite{Barcelo2011AnalogueGravity}. Volovik's work on superfluid
$^3$He--A, in particular, demonstrates how Lorentz invariance and gauge fields can
appear as low-energy emergent structures of an underlying quantum liquid with
nontrivial microphysics~\cite{Volovik2003HeliumDroplet}. Our three-dimensional
