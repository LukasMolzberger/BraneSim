...
and introduces the minimal geometric-phase (Berry) readout we will later apply to prepared narrowband wave packets.
...
In this revision, the more elaborate Berry diagnostics (curvature maps, defect/source reconstruction, non-Abelian transport)
