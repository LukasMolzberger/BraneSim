...
The structure of the paper mirrors a substrate--first perspective, but is now
organized explicitly as a layered model.
...
\emph{spectral-to-Berry-to-gauge} pipeline that will be used to interpret
emergent electromagnetism and spin structure.
Section~\ref{experimental-setting} describes the discrete simulation framework
and the practical implementation of this pipeline (band isolation, numerical
Berry connection/curvature, reconstruction of effective gauge fields), including
a falsifiable test plan.
Finally, Sections~\ref{discussion} and~\ref{conclusion} summarize limitations,
