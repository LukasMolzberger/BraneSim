...
\item \textbf{Substrate layer:} \\
  ...
  geometric transverse--lateral coupling \\
...
is real-valued, $\boldsymbol\xi(x,t)\in\mathbb R^4$.
In practice we also retain the accompanying velocity / momentum field
$\mathbf v(x,t)=\partial_t\mathbf X(x,t)$ and $\boldsymbol\Pi(x,t)=\rho_m\mathbf v(x,t)$,
so that the spectral layer operates on the full local phase-space information.
To construct a complex envelope with a well-defined local phase, we must first isolate a
