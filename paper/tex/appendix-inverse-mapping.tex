...
\end{equation}
where $\mathbf v_{\mathrm{energy}}$ is the usual local energy-transport
velocity of the electromagnetic configuration, aligned with the
dominant propagation direction for a null wave packet.
...
For small, predominantly longitudinal deformations along a preferred
propagation direction we can approximate the dynamics of $\xi_\perp$ by
an effective one-dimensional wave equation along an arclength coordinate
$s$ that follows this direction,
\begin{equation}
