...
In this manuscript, the electromagnetic sector is reconstructed from the Berry connection and curvature of band-isolated substrate modes (Sections~ef{sec:band-isolation-route2}--ef{sec:berry-pullback-em}), rather than from a direct coarse-graining of a particular embedding component such as a raw transverse-displacement field (often represented by $X^4$ in a convenient gauge).
This has two immediate implications. First, the relevant $U(1)$ is not a component-wise phase of the substrate, but the single overall phase freedom of an isolated complex polarization line bundle. Second, the homogeneous Maxwell equations become kinematic identities (Bianchi) of the reconstructed curvature, while the inhomogeneous sector becomes a dynamical and defect-driven question: effective sources must emerge from degeneracies/topological defects of the substrate, rather than being postulated.
