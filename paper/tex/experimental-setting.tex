...
Instead, we construct a complex envelope $u(x,t)\in\mathbb C^4$ from the real phase-space pair
$(\boldsymbol\xi(x,t),\mathbf v(x,t))$ by a consistent quadrature (analytic-signal) representation
of the prepared carrier, and normalize $\tilde u=u/\|u\|$.
