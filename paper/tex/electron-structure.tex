...
In the language of the Berry/Wilczek--Zee connection introduced in
Section~\ref{sec:brane-to-berry-to-em}, this $4\pi$ periodicity corresponds to a
non-Abelian holonomy around the defect core: the frame of polarization
eigenvectors becomes ill-defined at the defect center, and transport around a
closed loop enclosing it yields a holonomy element in $\mathrm{SU}(2)$ rather
than $\mathrm{U}(1)$. This supplies a concrete geometric mechanism for the
emergence of spin-$1/2$ behavior at the effective layer.